    ...
    <BodyContainer>
      ...
      <CaseStudy dividerText="MORE" summary={summary}>
        <TextContainer>
          ...
          <ImageContainer src="/lp-rebrand/old-site.png" />
        </TextContainer>
        <TextContainer>
          ...
          <ImageContainer src="/lp-rebrand/iteration-1.png" />
          <p>
        ...
        <TextContainer>
          ...
          <h3>2 Mood Board</h3>
          <ImageContainer src="/lp-rebrand/moodboard.png" />
          <p>
          ...
          <ImageContainer src="/lp-rebrand/sketches.png" />
          <ImageContainer src="/lp-rebrand/illustrations.png" />
          <p>
          ...
          <ImageContainer src="/lp-rebrand/brand-guideline.png" />
          <p>
        ...
        <TextContainer>
          <h2>Marketing</h2>
          <ImageContainer src="/lp-rebrand/social.png" />
          <p>
        ...
        <TextContainer>
          <h2>Slide Deck</h2>
          <ImageContainer src="/lp-rebrand/slide-deck.png" />
        </TextContainer>
        <TextContainer>
          <h2>Sponsorship Package</h2>
          <ImageContainer src="/lp-rebrand/sponsorship-package.png" />
          <p>
          ...
          <ImageContainer src="/lp-rebrand/versions.png" />
        </TextContainer>
        <TextContainer>
          <h2>Swag Design</h2>
          <p>
          ...
          <ImageContainer src="/lp-rebrand/swag-design.png" />
          ...
          <ImageContainer src="/lp-rebrand/swag-photos.png" />
        </TextContainer>
        <TextContainer>
          <h2>What’s Next?</h2>
          <p>
