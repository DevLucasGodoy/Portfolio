    ...
    <BodyContainer>
      ...
      <CaseStudy dividerText="MORE" summary={summary}>
        ...
        <TextContainer>
          ...
          <ImageContainer src="/fispan/analogy.png" />
          <p>
        ...
        <TextContainer>
          ...
          <ImageContainer src="/fispan/constraints.png" />
          <p>
        ...
        <TextContainer>
          ...
          <p>
            ...
            <br />
            <br />
            For example, after submitting a design to the client, they asked to
            make their logo bigger, but doing so reduces the usable screen real
            estate and breaks the app’s visual balance. I would then try to
            adapt my existing design to their specific request, but found that
            this was at times done at the expense of the end user.
          </p>
          <ImageContainer src="/fispan/client-request.png" />
          <p>
        ...
        <TextContainer>
          ...
          <ImageContainer src="/fispan/diving-deeper.png" />
          <p>
        ...
        <TextContainer>
          ...
          <ImageContainer src="/fispan/error-flow-ideal.png" />
          <p>
          ...
          <ImageContainer src="/fispan/error-flow-actual.png" />
          <p>
          ...
          <ImageContainer src="/fispan/three-versions.png" />
        </TextContainer>
        <TextContainer>
          ...
          <ImageContainer src="/fispan/sticky-notes.png" />
        </TextContainer>
        <TextContainer>
          <h2>Conclusion</h2>
